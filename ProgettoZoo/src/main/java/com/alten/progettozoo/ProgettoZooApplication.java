...
public class ProgettoZooApplication {
    ...
    public static void main(String[] args) {
        ...
        // Creo un ArrayList contenente le aquile
        ...
        // Creo un ArrayList contenente le tigri
        ...
        // Creo un ArrayList contenente i leoni
        ...
        findTallestAnimalAmongASpecie(eagles);
        findTallestAnimalAmongASpecie(tigers);
        findTallestAnimalAmongASpecie(lions);

        findShortestAnimalAmongASpecie(eagles);
        findShortestAnimalAmongASpecie(tigers);
        findShortestAnimalAmongASpecie(lions);

        findHeaviestAnimalAmongASpecie(eagles);
        findHeaviestAnimalAmongASpecie(tigers);
        findHeaviestAnimalAmongASpecie(lions);

        findLightestAnimalAmongASpecie(eagles);
        findLightestAnimalAmongASpecie(tigers);
        findLightestAnimalAmongASpecie(lions);

        findLongestTailAmongTailedAnimals(allAnimals);

        findBiggestWingspanAmongWingedAnimals(allAnimals);
    }

    private static void findTallestAnimalAmongASpecie(List<? extends Animal> specie) {
    ...
    private static void findShortestAnimalAmongASpecie(List<? extends Animal> specie) {
    ...
    private static void findHeaviestAnimalAmongASpecie(List<? extends Animal> specie) {
    ...
    private static void findLightestAnimalAmongASpecie(List<? extends Animal> specie) {
    ...
    private static void findBiggestWingspanAmongWingedAnimals(List<Animal> allAnimals) {
